...
class GameLogic:
    def __init__(self, size):
        self.size = size
        self.n = size + 1  # Количество точек
    ...
    def get_bot_move(self, difficulty, offset, step):
        ...
        # 1. Поиск хода, который приносит очко (Medium и Hard)
        ...
        # 2. Логика для Hard (не подставлять квадраты игроку)
        if difficulty == "hard":
        ...
        # 3. Случайный ход (Easy или если нет безопасных ходов)
